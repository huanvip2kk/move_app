...
class S {
  ...
  String get phoneNumberWrongType {
    return Intl.message(
      'Phone number wrong type',
      name: 'phoneNumberWrongType',
      desc: '',
      args: [],
    );
  }

  /// `Wait message and put OTP`
  String get waitMSGAndPutOTP {
    return Intl.message(
      'Wait message and put OTP',
      name: 'waitMSGAndPutOTP',
      desc: '',
      args: [],
    );
  }
  ...
  String get maybeYouWantToSee {
    return Intl.message(
      'MAYBE YOU WANT TO SEE',
      name: 'maybeYouWantToSee',
      desc: '',
      args: [],
    );
  }
